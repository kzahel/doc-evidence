      ...
      <section className={styles.inspection}>
        <section className={styles.visual} aria-label="Rendered source page">
          ...
          <div className={styles.pageFrame}>
            ...
            {renderQuery.error && <FailureState title="Page render failed" error={renderQuery.error} />}
        ...
        <section className={styles.outputs}>
          {groupsQuery.isLoading && <LoadingState label="Loading extractor representations" />}
          {groupsQuery.error && <FailureState title="Extractor output unavailable" error={groupsQuery.error} />}
